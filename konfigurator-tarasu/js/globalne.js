function Globalne() {
    this.debug = false;
    this.pathJsFiles = '';
    // Tłumaczenia są definiowane w trakcie inicjalizacji main.php
    this.tlumaczenia = {};
    this.aktywnyKrok = 1;
    this.maksKrok = 7;
    ...
    /**
     * Zmienna definiuje proporcje, potrzebne do obliczania długości
    ...
    this.hartikaKodyTechniczne = {
        ...
        deski: {
            ...
            // Natura 3D - rozdzielone kolory (nie pary), ale z tym samym kodem dla pary
            NATURA_3D: {
                JESION: {
                    NAZWA: "Hartika Tarase Natura 3D 22x140mm Jesion",
                    KOD: "HZ-BPS03-4-1/2"
                },
                WENGE: {
                    NAZWA: "Hartika Tarase Natura 3D 22x140mm Wenge",
                    KOD: "HZ-BPS03-4-1/2"
                },
                IPE: {
                    NAZWA: "Hartika Tarase Natura 3D 22x140mm IPE",
                    KOD: "HZ-BPS03-4-3/4"
                },
                TEAK: {
                    NAZWA: "Hartika Tarase Natura 3D 22x140mm Teak",
                    KOD: "HZ-BPS03-4-3/4"
                }
            }
        },
        ...
        klipsy: {
            ...
            // Dla Natura 3D wyłącznie startowy i środkowy dla 5mm
            NATURA_3D: {
                klips_startowy_kst: 'HKNT-01-0-5',
                klips_srodkowy_ksr: 'HKNT-02-0-5'
            }
        }
    }
}
