...
//weryfikacja danych
        ...
        var Warunek_1 = excelFunctions.ifWithStatus(excelFunctions.or((J11 / E22 - excelFunctions.rounddown(J11 / E22, 0)) * E22 >= 0.5, J11 / E22 - excelFunctions.rounddown(J11 / E22, 0) <= 0), "wymiary poprawne", "warunek_komunikat_zmien_wymiar_D_lub_B_tarasu_dlugosc_deski");
        var Warunek_2 = excelFunctions.ifWithStatus(excelFunctions.or((J4 / E22 - excelFunctions.rounddown(J4 / E22, 0)) * E22 >= 0.5, J4 / E22 - excelFunctions.rounddown(J4 / E22, 0) <= 0), "wymiary poprawne", "warunek_komunikat_zmien_wymiar_B_tarasu_dlugosc_deski");
        var Warunek_3 = excelFunctions.ifWithStatus(excelFunctions.or((J10 / E22 - excelFunctions.rounddown(J10 / E22, 0)) * E22 >= 0.5, J10 / E22 - excelFunctions.rounddown(J10 / E22, 0) <= 0), "wymiary poprawne", "warunek_komunikat_zmien_wymiar_H_tarasu_dlugosc_deski");
...
//weryfikacja danych
        ...
        var Warunek_1 = excelFunctions.ifWithStatus(excelFunctions.or((J3 / E22 - excelFunctions.rounddown(J3 / E22, 0)) * E22 >= 0.5, J3 / E22 - excelFunctions.rounddown(J3 / E22, 0) <= 0), "wymiary poprawne", "warunek_komunikat_zmien_wymiar_A_tarasu_dlugosc_deski");
        var Warunek_2 = excelFunctions.ifWithStatus(excelFunctions.or((J5 / E22 - excelFunctions.rounddown(J5 / E22, 0)) * E22 >= 0.5, J5 / E22 - excelFunctions.rounddown(J5 / E22, 0) <= 0), "wymiary poprawne", "warunek_komunikat_zmien_wymiar_C_tarasu_dlugosc_deski");
        var Warunek_3 = excelFunctions.ifWithStatus(excelFunctions.or((J9 / E22 - excelFunctions.rounddown(J9 / E22, 0)) * E22 >= 0.5, J9 / E22 - excelFunctions.rounddown(J9 / E22, 0) <= 0), "wymiary poprawne", "warunek_komunikat_zmien_wymiar_G_tarasu_dlugosc_deski");
//ILOŚC DESKI METRY BIEŻACE MBD
