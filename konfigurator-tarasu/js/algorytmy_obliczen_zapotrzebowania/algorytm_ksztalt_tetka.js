...
//weryfikacja danych
        ...
        var Warunek_1 = excelFunctions.ifWithStatus(excelFunctions.or((H4 / C22 - excelFunctions.rounddown(H4 / C22, 0)) * C22 >= 0.5, H4 / C22 - excelFunctions.rounddown(H4 / C22, 0) <= 0), "wymiary poprawne", "warunek_komunikat_zmien_wymiar_B_tarasu_dlugosc_deski");
