...
if($lang == 'en'){
    ...
    $translation["hartika_adres"] = "Hartika Sp. z o.o.<br>
                ul. Przemysłowa 9 | PL 19-230 Szczuczyn<br>
                tel. +370 686 48818 | <a href=\"mailto:hartika@hartika.com">hartika@hartika.com</a> | <a
                        href=\"http://www.hartika.com\">www.hartika.com</a>";
} else {
...
if (isset($_POST["generujPDF"]) && $_POST["generujPDF"]  == 1) {
    ...
    try {
        include(__DIR__ . '/generowaniePDF/mpdf/mpdf.php');
    } catch (Exception $e) {
        var_dump( $e);
        die();
    }
